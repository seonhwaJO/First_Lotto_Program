...
public class StaticsWinningVO {
	...
	public StaticsWinningVO(int roundNumber, String autoInfo,TreeSet<Integer> customList, TreeSet<Integer> winningList,
			TreeSet<Integer> resultList) {
		this.roundNumber=roundNumber;	//회차정보 셋팅
		this.autoInfo=autoInfo;	//사용자 수동/자동 정보
	...
	public String getAutoInfo() { return autoInfo; }	//사용자 수동/자동 정보 가져오기
