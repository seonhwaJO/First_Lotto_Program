...
public class ApplicationView implements errorView{
	...
	public void showMenu() {	// 프로그램 메뉴
		...
		System.out.println("===================================================");
		System.out.println("1. 회원가입 2. 로그인  3. 금액 충전 4. 로또 구매  5. 로또 게임   6.사용자 게임 정보 확인 7. 로그아웃 8. 종료");
	...
	public void showLogout() {
		System.out.println("로그아웃되었습니다. 메인메뉴로 돌아갑니다.");
	}
